...
namespace nihil
{
    ...
    size_t buildBVH4(std::vector<nihil::graphics::Object*>& primitives, std::vector<size_t>& indices, size_t start, size_t end, size_t parent, Carbo::ECSAllocator<BVH4Node>& allocator, Carbo::ECSAllocator<BVH4LeafNode>& leafAllocator, Carbo::ECSAllocator<BVH4ColdNode>& coldAllocator);
    void cullBVH4(size_t root, const std::array<Plane, 6>& planes, Carbo::ECSAllocator<BVH4Node>& allocator, Carbo::ECSAllocator<BVH4LeafNode>& leafAllocator, Carbo::ECSAllocator<BVH4ColdNode>& coldAllocator, std::vector<size_t>& visible, std::vector<size_t>* reusableStack = nullptr);
