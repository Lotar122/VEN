...
namespace nihil
{
    ...
    public:
        Resource(vk::Fence _res, vk::Device _device)
        {
            ...
            Carbo::Logger::Log("The specialized constructor for vk::Fence called.");
        }
        Resource() { Carbo::Logger::Log("The specialized constructor for vk::Fence called.");};
        void destroy() override
        {
            ...
            Carbo::Logger::Log("Destroying vk::Fence");
        }
        ~Resource() override 
        {
            if(!destroyed) Carbo::Logger::Warn("A vk::Fence has gone out of scope without being destroyed, destroying automatically.");
            destroy();
        };
