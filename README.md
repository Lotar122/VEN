# VEN - vis-ex-nihil #
VEN is a lightweight vulkan based engine written in C++. It has the ambition of becoming the metaverse.

I started VEN in 2023, as a simplistic Vulkan renderer that could run on everything, by this i mean anything that supports Vulkan.
...
https://github.com/Lotar122/vis-ex-nihil-render <br/>
https://github.com/Lotar122/vis-ex-nihil-net (not yet, still under development) <br/>
